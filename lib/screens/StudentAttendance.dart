...
class StudentAttendanceScreen extends StatefulWidget {
  ...
  _StudentAttendanceScreenState createState() =>
      _StudentAttendanceScreenState(id: id);
}
...
class _StudentAttendanceScreenState extends State<StudentAttendanceScreen> {
  ...
  _StudentAttendanceScreenState({this.id});
  ...
  void didChangeDependencies() {
    ...
    if (id != null) {
      ...
      attendances = getAllStudentAttendance(id, toDate, fromDate);
    }
    else {
        ...
        setState(() {
          ...
          DateTime date = DateTime.now();
          var toDate, fromDate;
//          toDate=date.year.toString()+'-'+date.month.toString()+'-1';
//          fromDate=date.year.toString()+'-'+date.month.toString()+'-30';
...
//                        print(snapshot.data.attendances);
...
//
    ...
    final response = await http.get(InfixApi.getStudentAttendence(
        id.toString(), toDate, fromDate, 'getStudentAttendence', token));
    ...
    //return StudentAttendanceList.fromJson([{"atd":"123"}]);
  }
