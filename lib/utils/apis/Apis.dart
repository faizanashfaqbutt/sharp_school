class InfixApi {
  static String root = 'http://192.168.10.12/school/';
  ...
  static String changePassword(String id,String old_password, String new_password,String user_type,String request_for,String token){
    print(baseApi +
        'api?old_password=' + old_password +
        '&id=' +id+
  ...
  static String login(String username, String password,String user_type,String request_for) {
    return baseApi +
...
//  static String profile(String username,String user_type,String request_for, String token) {
//   return baseApi +
//        'api?username=' + username +
//        '&user_type=' + user_type+
//        '&request_for=' + request_for+
//        '&token=' + token;
//  }
  static String profile(String id,String user_type,String request_for, String token) {
    print(baseApi +
        'api?id=' + id +
        '&user_type=' + user_type+
        '&request_for=' + request_for+
  ...
  // static String getFees(String student_id,String student_class,String student_section,String request_for,String token) {
  //   return baseApi +
  ...
  //
  // }
  static String getFees(String student_id,String request_for,String token) {
    return baseApi +
        'api?student_id=' + student_id+
        '&request_for=' + request_for+
        '&token=' + token;

  }

  // static String getTotalFees(String student_id,String student_class,String student_section,String request_for,String token) {
  //   return baseApi +
  //       'api?student_class=' + student_class +
  //       '&student_section=' + student_section+
  //       '&student_id=' + student_id+
  ...
  static String getTotalFees(String student_id,String request_for,String token) {
    return baseApi +
        'api?student_id=' + student_id+
        '&request_for=' + request_for+
        '&token=' + token;
  ...
  static String getSale(String student_id,String user_type,String request_for,String token) {
    return baseApi +
        'api?user_type=' + user_type+
        '&student_id=' + student_id+
        '&request_for=' + request_for+
        '&token=' + token;

  }
  static String getTotalSale(String student_id,String user_type,String request_for,String token) {
    return baseApi +
        'api?user_type=' + user_type+
        '&student_id=' + student_id+
        '&request_for=' + request_for+
  ...
  static String getStudentRoutine(String id,String day,String request_for, String token) {
    print(baseApi +
        'api?id=' + id +
        '&day=' + day+
        '&request_for=' + request_for+
  ...
  // static String getSubjects(String student_class,String student_section,String request_for,String token) {
  //   return baseApi +
  //       'api?student_class=' + student_class +
  //       '&student_section=' + student_section+
  //       '&request_for=' + request_for+
  //       '&token=' + token;
  // }
  static String getSubjects(String id, String request_for,String token) {
    return baseApi +
        'api?id=' + id +
        '&request_for=' + request_for+
        '&token=' + token;
  ...
  // static String getTeacherOfStudent(String student_class,String student_section,String request_for,String token) {
  //   return baseApi +
  //       'api?student_class=' + student_class +
  //       '&student_section=' + student_section+
  //       '&request_for=' + request_for+
  ...
  //
  // }
  static String getTeacherOfStudent(String id, String request_for,String token) {
    return baseApi +
        'api?id=' + id +
        '&request_for=' + request_for+
        '&token=' + token;
...
//  }
  static String getTeacherAttendence(String id,String toDate,String fromDate,String request_for,String token){
  ...
  static String sendStudentAttendance(String request_for,String token){
  ...
  static String getStudentAttendence(String id,String toDate,String fromDate,String request_for,String token){
  ...
  //this function will be deleted soon getSectionById
  static String getSectionById(int id,int classId){
    return baseApi+"teacher-section-list?id=$id&class=$classId";
  }
  static String getSectionByClassId(String id, String classId,request_for,token){
  ...
  static String getClassesOfTeacher(String id,String request_for,String token){
  ...
  static String getStudentsOfTeacherSearch(String class_id,String section_id,String name,String roll,String request_for,String token){
    print(
        baseApi +
  ...
  //this below method will be deleted soon getClassById
  ...
  static String getTeacherSubject(String id,String request_for,String token){
    print(baseApi +
        'api?id=' + id+
        '&request_for=' + request_for+
        '&token=' + token);
  ...
  static String getTeacherRoutine(String id,String day,String request_for,String token){
    print(baseApi +
        'api?id=' + id +
        '&day=' + day+
        '&request_for=' + request_for+
...
//  }
  static String getParentChildren(String id,String request_for,String token){
     try{
       print(baseApi +
           'api?id=' + id+
           '&request_for=' + request_for+
